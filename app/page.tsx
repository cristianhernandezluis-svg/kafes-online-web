    ...
    <main className="min-h-screen bg-black text-white">
      ...
      <section className="max-w-7xl mx-auto py-20 px-6 grid md:grid-cols-2 gap-10 items-center">
        ...
        <div>
          ...
          <div className="flex gap-4 mt-8">
            ...
            <button className="bg-yellow-400 text-black px-8 py-4 rounded-2xl font-black text-xl hover:scale-105 transition">
              VER CATÁLOGO
            </button>

            <button className="border border-yellow-400 text-yellow-400 px-8 py-4 rounded-2xl font-black text-xl hover:bg-yellow-400 hover:text-black transition">
              OFERTAS
            </button>
      ...
      <section className="max-w-7xl mx-auto grid md:grid-cols-3 gap-6 px-6 pb-20">
        ...
        <Benefit
          ...
          text="Despachamos rápido y seguro."
        />

        <Benefit
          icon={<ShieldCheck />}
          title="Pago Seguro"
          text="Integración preparada para Izipay."
        />

        <Benefit
          icon={<Headphones />}
          title="Atención Personalizada"
          text="Soporte rápido por WhatsApp."
        />
          ...
          >
            ...
            <div className="p-6">
              ...
              <p className="text-zinc-400 mt-3 leading-relaxed">
                Incluye 2 baterías de 21V. Ideal para poda, corte de madera,
                trabajos de campo y uso profesional.
              </p>
              ...
              <div className="mt-6 flex gap-3">
                ...
                <button className="w-full bg-yellow-400 hover:bg-yellow-300 text-black py-4 rounded-2xl font-black text-lg transition">
                  Ver detalles
                </button>
      ...
      <a
        ...
        target="_blank"
        className="fixed bottom-6 right-6 bg-green-500 hover:bg-green-600 text-white px-6 py-4 rounded-full font-black shadow-2xl"
      >
        WhatsApp
      </a>
